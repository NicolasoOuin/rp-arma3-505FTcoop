...
switch (INS_op_faction) do
{
	case 1 : // CSAT (no mods)
	{
		...
		[EAST,0,0]execVM "eos1\OpenMe.sqf";
	};
	case 2 : // AAF (no mods)
	{
		[RESISTANCE,2,2]execVM "eos\OpenMe.sqf";
		[RESISTANCE,2,2]execVM "eos1\OpenMe.sqf";
	};
...
call compile (preprocessFileLineNumbers "functions\compile.sqf"); // Ajout du fichier chemins des fonctions Mébisis
